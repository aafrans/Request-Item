        ...
        <div class="bg-white flex-1 flex items-center justify-center p-6 lg:p-12">
            <div class="w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                ...
                <form method="POST" action="{{ route('register') }}" class="w-full">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-blue-500 dark:hover:bg-blue-600">Register</button>
                </form>
                <p class="mt-6 text-sm text-gray-600 dark:text-gray-400">
                    Already have an account? <a href="{{ route('login') }}"
                        class="font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Log
                        in</a>
                </p>
            </div>
        </div>
