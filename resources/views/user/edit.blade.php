...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            @if ($errors->any())
                <div class="mb-4">
                    <div class="font-medium text-red-600">There were some issues with your input.</div>
            ...
            <form method="POST" action="{{ route('user.update', $user->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <select name="role" id="role" required class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                ...
                <div class="flex items-center justify-end">
                    <a href="{{ route('user.dashboard') }}" class="text-gray-600 hover:text-gray-900 underline mr-4">Cancel</a>
                    <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">Update</button>
                </div>
            </form>
        </div>
    </div>
